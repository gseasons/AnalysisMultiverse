...
class MultiverseConfig():
    ...
    def essential(self):
        ...
        ttk.Label(self.main_config, text='Data directory:').grid(row=11)
        ttk.Label(self.main_config, text=self.data_dir).grid(row=11, column=1)
        ttk.Label(self.main_config, text='Output directory:').grid(row=12)
        ttk.Label(self.main_config, text=self.output).grid(row=12, column=1)
