...
# =============================================================================
#     if type(frame) != str:
#         indexes = [(ind_start, frame.shape[0]+pop.shape[0])]#frame.shape[0], frame.shape[0]+pop.shape[0])]      
#     else:
#         indexes = [(ind_start, ind_start+pop.shape[0])]#pop.shape[0]]
# =============================================================================
...
# =============================================================================
        ...
        for param in unique_cols_temp:#ADD COLS FOR P, R, SCORE
...
def traverse(dic, flow, suffix, pipeline, to_run):
    if to_run:
        start_pipe_ = min(to_run)#NOT SURE THIS IS THE BEST METHOD -> NEED TO KNOW FIRST ONE TO SPLIT
    else:
