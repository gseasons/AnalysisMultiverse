...
def data_driven(mask, unsmoothed, k, kcc, TR, lp=0.01, hp=0.1):
    ...
    from nipype.interfaces.fsl import IsotropicSmooth, ExtractROI
    unsmoothed = ExtractROI(in_file=unsmoothed, t_min=10, t_size=-1).run().outputs.roi_file
...
unsmoothed = '/Users/grahamseasons/fMRI/analysis_multiverse/hide/testing/code/sub-002S6009_task-rest_bold_roi_mcf_st_warp_reho_regressed_maths.nii.gz'
#unsmoothed = '/Users/grahamseasons/fMRI/analysis_multiverse/hide/testing/code/sub-002S6009_task-rest_bold_roi_mcf_st_warp_regressed_maths.nii.gz'#'/Users/grahamseasons/fMRI/analysis_multiverse/hide/testing/code/sub-002S6009_task-rest_bold_roi_mcf_st_warp_reho_regressed_maths.nii.gz'
mask = '/usr/local/fsl/data/standard/MNI152_T1_2mm_brain.nii.gz'
k = 'vertices'
kcc = 0.5
TR = 3
data_driven(mask, unsmoothed, k, kcc, TR)
