...
def main():
    ...
    exp_dir = '/Volumes/NewVolume/ds000114-new' #right'#'allsubs'
    ...
    if 'anat' and 'func' in types:
        ...
        go.inputs.inputnode.warp_post_feat = [True, True]
        go.inputs.inputnode.resting = [{'atlas': 'harvard', 'seed': 'cing post', 'seed_thr': 25}]*2
        go.run()
